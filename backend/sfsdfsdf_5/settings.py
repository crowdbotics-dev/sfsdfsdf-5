"""
Django settings for sfsdfsdf_5 project.
...
WSGI_APPLICATION = 'sfsdfsdf_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sfsdfsdf_5 API",
    "DESCRIPTION": "API documentation for sfsdfsdf_5 App",
    "VERSION": "v1",
}
